...
##5.请取出最中间的长度为5的子串。
print dcontent[len(dcontent)/2:len(dcontent)/2+5].encode('utf-8')   #注意是在dcontent上的操作
##6.请取出最后2个字符。
print 'aaaa--------'
print dcontent[-2:].encode('utf-8')  #注意[ : ]  ,别忘了有：
print 'bbbb--------'
...
print a.find('i',a.find('china'))  #记住
print a.rfind('i')
